...
print(f"{str_amount_fraction(milk)} {str_units(milk, UNIT_MILK)} {str_single_plural(milk, TXT_MILK)} ({unit2ml(milk, UNIT_MILK)}) ml") 
print(f"{str_amount_fraction(salt)} {str_units(salt, UNIT_SALT)} {str_single_plural(salt, TXT_SALT)} ({ml2gram(unit2ml(salt, UNIT_SALT),GRAM_PER_ML_SALT)} gram)")
print(f"{str_amount_fraction(pepper)} {str_units(pepper, UNIT_PEPPER)} {str_single_plural(pepper, TXT_PEPPER)} ({ml2gram(unit2ml(pepper, UNIT_PEPPER),GRAM_PER_ML_PEPPER)} gram)")
print(f"{str_amount_fraction(oil)} {str_units(oil, UNIT_OIL)} {str_single_plural(oil, TXT_OIL)} ({unit2ml(oil, UNIT_OIL)}) ml")
...
print(f"{str_amount_fraction(spinach)} {str_units(spinach, UNIT_SPINACH)} {str_single_plural(spinach, TXT_SPINACH)} ({ml2gram(unit2ml(spinach, UNIT_SPINACH),GRAM_PER_ML_SPINACH)} gram)")
print(f"{str_amount_fraction(cheese)} {str_units(cheese, UNIT_CHEESE)} {str_single_plural(cheese, TXT_CHEESE)} ({ml2gram(unit2ml(cheese, UNIT_CHEESE),GRAM_PER_ML_CHEESE)} gram)")
print('-----------------------------------------------')